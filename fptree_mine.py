...
def sort_cpb_by_freq(cpb_all):
	...
	return FPT.reorder_items(cpb_all, sort_key=FPT.SORT_KEY)
...
def mine_tree(p=CL.deque([]), header_table=FPT.htab, min_spt=FPT.MIN_SPT, trans_count=FPT.TRANS_COUNT, f_list=FPT.htab, mfis=FPT.MIN_FREQ_ITEMSET_LENGTH,
	debug=1):
